/* Definitions and headers for communication on the Wayland API.
...
/* Structure representing a color used in drawing with Cairo.  */
...
#define NativeRectangle cairo_rectangle_t
